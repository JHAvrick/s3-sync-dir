 ...
 */
async function syncDir(config, callbacks){
	let s3 = config.s3;
...
//Get directory tree
//Sort all directory objects in sorting function (based on special hash)
//handleTreeSync(tree, objects)
//Sort into possible categories:
	//unmatchedDir
		//uploadDir
	//unmatchedDirObject
		//was it ever synced here?
			//YES - delete the dir object
			//NO - create directory
	//matchedDeleted
		//is the dir more recent?
			//undelete object
		//if not
			//delete dir
